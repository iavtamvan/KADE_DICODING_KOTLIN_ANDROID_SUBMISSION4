...
import com.iav.kade_2.R.id.navigation_notifications
...
class TestSkenario {
    ...
    fun behaviorTest(){
        ...
        Espresso.onView(ViewMatchers.withId(navigation_notifications)).check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
